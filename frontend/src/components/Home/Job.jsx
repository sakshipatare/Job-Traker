  ...
  const fetchJobs = async () => {
    try {
      ...
      const response = await fetch(
            `http://localhost:5000/jobs/jobs?page=${page}&limit=${limit}&search=${searchTerm}&title=${filters.title}&location=${filters.location}&minSalary=${filters.minSalary}&sortBy=createdAt&order=desc`
        );
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#050014] via-[#08001f] to-[#050014] text-slate-100">
      ...
      <main className="relative pt-28 md:pt-32 pb-20 md:pb-24 px-6 overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-32 -left-32 h-80 w-80 rounded-full bg-fuchsia-600/35 blur-3xl" />
          <div className="absolute top-40 -right-40 h-[420px] w-[420px] rounded-full bg-purple-500/35 blur-3xl" />
          <div className="absolute bottom-0 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-indigo-500/25 blur-3xl" />
        </div>
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <div className="mb-10 md:mb-12">
            <div className="inline-flex items-center space-x-2 rounded-full border border-fuchsia-500/40 bg-fuchsia-500/10 px-4 py-1.5 text-xs font-medium text-fuchsia-200 shadow-sm">
              ...
              <span>Find roles. Apply faster. Track everything.</span>
            </div>
            ...
            <p className="mt-3 text-sm sm:text-base md:text-lg text-slate-300 max-w-2xl">
              Search openings, filter by location and salary, and apply in a few
              clicks. Your application status stays synced in JobTracker.
            </p>
          </div>
        ...
        {message && (
          <div
            className={`mb-8 p-4 rounded-xl flex items-center space-x-3 animate-in fade-in fixed top-20 right-4 z-40 shadow-[0_0_30px_rgba(129,140,248,0.35)] max-w-md backdrop-blur border ${
          ...
          >
            ...
            <span
              className={
                message.type === "success" ? "text-emerald-100" : "text-rose-100"
              }
            >
              {message.text}
            </span>
        ...
        {/* Search Section */}
        <div className="rounded-3xl border border-purple-500/40 bg-white/5 p-6 md:p-8 mb-10 shadow-[0_0_35px_rgba(129,140,248,0.25)] backdrop-blur">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center mb-6">
            <div className="flex-1 relative w-full">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl border border-purple-500/40 bg-white/5 text-slate-50 placeholder:text-slate-500 focus:outline-none focus:border-fuchsia-400 focus:ring-1 focus:ring-fuchsia-400/60 transition-all"
              />
            </div>
        ...
        jobs.length > 0 ? (
          ...
          <div className="text-center py-16">
            <Briefcase className="w-16 h-16 text-fuchsia-300/70 mx-auto mb-4" />
        ...
        {totalPages > 1 && (
          <div className="flex justify-center items-center gap-4 mt-10">
            <button
              ...
              disabled={page === 1}
              className="px-4 py-2 rounded-lg border border-purple-500/30 bg-white/5 text-slate-100 disabled:opacity-50 hover:bg-white/10 transition-colors"
            >
              Previous
            </button>
        ...
        {selectedJob && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-[#070017]/90 rounded-2xl shadow-[0_0_45px_rgba(129,140,248,0.55)] w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-purple-500/40">
              {/* Modal Header */}
